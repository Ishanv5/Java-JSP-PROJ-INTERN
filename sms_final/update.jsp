    ...
    <body>
        <center>
            ...
            <form>
                ...
                <br/><br/>
                <input type="text" placeholder="Enter Name" name="na" />
                <br/><br/>
                <input type="number" placeholder="Enter subject 1 marks" name="s1" />
                <br/><br/>
                <input type="number" placeholder="Enter subject 2 marks" name="s2" />
                <br/><br/>
                <input type="number" placeholder="Enter subject 3 marks" name="s3" />
                <br/><br/>
          ...
          if(request.getParameter("btn") != null)
          {
             ...
             try
             {
                 ...
                 String sql="update stud set rno=?,name=?,m1=?,m2=?,m3=? where rno='"+rno+"'";
